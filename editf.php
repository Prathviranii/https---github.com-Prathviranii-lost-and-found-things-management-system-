...
$sql = "SELECT * FROM `fitems_info` WHERE 1";
...
$result = mysqli_query($conn, "UPDATE `fitems_info` SET `fName`='$firstname',`email`='$email',`idate`='$date',`contact`='$contact',`descri`='$description',`pic`='$pic' WHERE id=$id");
...
<?php
	...
	$sql = "SELECT * from `fitems_info` WHERE id=$id";
	$result = mysqli_query($conn, $sql);
	if($result){
...
<html>
<head>
	<title>delete found items |</title>
	<!-- Icons font CSS-->
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Update found item Info</h2>
                    <form id = "registration" action="editf.php" method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="file" placeholder="file" name="file" value="<?php echo $pic;?>">
                        </div>
