...
<head>
    ...
    <!-- Title Page-->
    <title>Add found | lost and found Management System</title>
...
<body>
    <header>
        <nav>
            <h1>lost and found items management system</h1>
            <ul id="navli">
                <li><a class="homeblack" href="addlost.php">Add lost items</a></li>
                <li><a class="homered" href="addfound.php">Add found items </a></li>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">found item info</h2>
                    <form action="process/addfoundprocess.php" method="POST" enctype="multipart/form-data">
